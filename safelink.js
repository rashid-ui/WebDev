//safelink blogger di bagikan gratis oleh https://pi-mathematics.blogspot.com v2.6.1
$(".idnblogProShow").click(function () {
  $(".safeWrap").fadeIn();
}),
  $(".idnblogProClose").click(function () {
    $(".safeWrap").fadeOut(),
        ...
        success: function (t) {
          ...
          if (void 0 !== l) {
            ...
            (resultgenerate =
              s[c] +
              "#?o=" +
              aesCrypto.encrypt(convertstr(e), convertstr("root"))),
              a.addClass("hidden"),
...
!(function (t) {
    ...
    init: function (e) {
      ...
      return (
        ...
        this.each(function () {
          ...
          e.data("pietimer") ||
            (e.addClass("pietimer"),
            e.css({ fontSize: e.width() }),
            e.data("pietimer", r),
            r.showPercentage && e.find(".percent").show(),
            r.fill && e.addClass("fill"),
            e.pietimer("start"));
        })
      );
    },
    ...
    drawTimer: function (e) {
      ...
      if (r) {
        ...
        $this
          ...
          $this.hasClass("fill")
            ? $this.find(".slice .pie").css({ backgroundColor: r.color })
            : $this.find(".slice .pie").css({ borderColor: r.color });
      }
    },
    start: function () {
      var e = t(this).data("pietimer");
  ...
  t.fn.pietimer = function (r) {
    return e[r]
      ...
      : "object" != typeof r && r
      ? void t.error("Method " + r + " does not exist on jQuery.pietimer")
    ...
    return (function (t) {
      ...
      function (t, e, r) {
        ...
        t.exports = function (t, e, r) {
          ...
          if (n.string(t))
            return (o = t), (a = e), (c = r), i(document.body, o, a, c);
          throw new TypeError(
      ...
      u = (n.BufferedBlockAlgorithm = i.extend({
        ...
        _process: function (e) {
          var r = this._data,
            ...
            c = i / (4 * a),
            s =
              (c = e ? t.ceil(c) : t.max((0 | c) - this._minBufferSize, 0)) * a,
            l = t.min(4 * s, i);
          if (s) {
    ...
    var d = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
      p = (r.AES = e.extend({
        ...
        decryptBlock: function (t, e) {
          ...
          (t[e + 1] = t[e + 3]),
            (t[e + 3] = r),
            this._doCryptBlock(t, e, this._invKeySchedule, l, u, f, h, i);
          r = t[e + 1];
          (t[e + 1] = t[e + 3]), (t[e + 3] = r);
        },
...
!(function (t) {
  ...
  (t.formatter = {
    ...
    (t.decrypt = function (e, r) {
      try {
        return CryptoJS.AES.decrypt(e, r, { format: t.formatter }).toString(
          CryptoJS.enc.Utf8
        );
      } catch (t) {
        return "";
...
$(".pi-mathematicsShow").click(function () {
    $(".safeWrap").fadeIn()
}), $(".pi-mathematicsClose").click(function () {
...
$(document).ready(function () {
    $("#btngenerate").on("click", function () {
        var e = $("#generateurl").val(),
            ...
            n = $("#resulturl");
        if ("" == e) return $("#generateurl").focus(), !1;
        $("#copytoclipboard").html(setCopyUrl), a.removeClass("hidden"), r.addClass("hidden"), $.ajax({
            url: "/feeds/posts/summary?alt=json-in-script",
            type: "get",
            dataType: "jsonp",
            success: function (t) {
...
function convertstr(t) {
    ...
    var e = {
        init: function (e) {
            ...
            return r = t.extend(r, e), this.each(function () {
                var e = t(this);
                e.data("pietimer") || (e.addClass("pietimer"), e.css({
                    fontSize: e.width()
                }), e.data("pietimer", r), r.showPercentage && e.find(".percent").show(), r.fill && e.addClass("fill"), e.pietimer("start"))
            })
        },
        stopWatch: function () {
            var e = t(this).data("pietimer");
        ...
        drawTimer: function (e) {
            ...
            if (r) {
                ...
                $this.find(".slice .pie").css({
                    ...
                    "-o-transform": "rotate(" + n + "deg)",
                    transform: "rotate(" + n + "deg)"
                }), $this.find(".percent").html(Math.round(e) + "%"), r.showPercentage && $this.find(".percent").show(), $this.hasClass("fill") ? $this.find(".slice .pie").css({
...
function (t, e) {
    ...
    return function (t) {
        ...
        t.exports = function (t, e, r) {
            ...
            if (n.node(t)) return h = e, d = r, (f = t).addEventListener(h, d), {
                destroy: function () {
                    f.removeEventListener(h, d)
                }
            };
            if (n.nodeList(t)) return s = t, l = e, u = r, Array.prototype.forEach.call(s, function (t) {
                t.addEventListener(l, u)
            }), {
                destroy: function () {
                    Array.prototype.forEach.call(s, function (t) {
        ...
        t.exports = function (t, e, r, n, o) {
            return "function" == typeof t.addEventListener ? i.apply(null, arguments) : "function" == typeof r ? i.bind(null, document).apply(null, arguments) : ("string" == typeof t && (t = document.querySelectorAll(t)), Array.prototype.map.call(t, function (t) {
                return i(t, e, r, n, o)
            }))
        }
    }, function (t, e) {
...
! function () {
    ...
    t.enc.Base64 = {
        stringify: function (t) {
            ...
            t.clamp();
            for (var i = [], o = 0; r > o; o += 3)
                for (var a = (e[o >>> 2] >>> 24 - o % 4 * 8 & 255) << 16 | (e[o + 1 >>> 2] >>> 24 - (o + 1) % 4 * 8 & 255) << 8 | e[o + 2 >>> 2] >>> 24 - (o + 2) % 4 * 8 & 255, c = 0; 4 > c && r > o + .75 * c; c++) i.push(n.charAt(a >>> 6 * (3 - c) & 63));
            var s = n.charAt(64);
            if (s)
        ...
        var d = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
            p = r.AES = e.extend({
                _doReset: function () {
                    for (var t = this._key, e = t.words, r = t.sigBytes / 4, i = 4 * ((this._nRounds = r + 6) + 1), o = this._keySchedule = [], a = 0; i > a; a++)
                        if (r > a) o[a] = e[a];
                            ...
                            var c = o[a - 1];
                            a % r ? r > 6 && a % r == 4 && (c = n[c >>> 24] << 24 | n[c >>> 16 & 255] << 16 | n[c >>> 8 & 255] << 8 | n[255 & c]) : (c = n[(c = c << 8 | c >>> 24) >>> 24] << 24 | n[c >>> 16 & 255] << 16 | n[c >>> 8 & 255] << 8 | n[255 & c], c ^= d[a / r | 0] << 24), o[a] = o[a - r] ^ c
                        } for (var s = this._invKeySchedule = [], p = 0; i > p; p++) {
                        a = i - p;
                        if (p % 4) c = o[a];
                        else c = o[a - 4];
                ...
                _doCryptBlock: function (t, e, r, n, i, o, a, c) {
                    ...
                    y = (c[l >>> 24] << 24 | c[u >>> 16 & 255] << 16 | c[f >>> 8 & 255] << 8 | c[255 & h]) ^ r[d++], v = (c[u >>> 24] << 24 | c[f >>> 16 & 255] << 16 | c[h >>> 8 & 255] << 8 | c[255 & l]) ^ r[d++], m = (c[f >>> 24] << 24 | c[h >>> 16 & 255] << 16 | c[l >>> 8 & 255] << 8 | c[255 & u]) ^ r[d++], g = (c[h >>> 24] << 24 | c[l >>> 16 & 255] << 16 | c[u >>> 8 & 255] << 8 | c[255 & f]) ^ r[d++];
                    t[e] = y, t[e + 1] = v, t[e + 2] = m, t[e + 3] = g
                },
                keySize: 8
            });
